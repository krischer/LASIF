...
class RotationsTestCase(unittest.TestCase):
    """
    Attempts to test the rotations as complete as possible as this is a very
    likely source of error and tough to get right.
    """
    ...
    def test_GetSphericalUnitVectors(self):
        """
...
def suite():
    return unittest.makeSuite(RotationsTestCase, "test")
