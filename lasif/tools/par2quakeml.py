...
from obspy.core.event import Catalog, Magnitude, Event, Origin, FocalMechanism, Tensor, MomentTensor, NodalPlanes

def par2quakeml(Par_filename,QuakeML_filename,rotation_axis=[0.0,1.0,0.0],rotation_angle=-57.5,origin_time="2000-01-01 00:00:00.0",event_type="other event"):
    ...
    lat,lon=rot.rotate_lat_lon(lat_old, lon_old, rotation_axis, rotation_angle)
    Mrr,Mtt,Mpp,Mtr,Mpr,Mtp=rot.rotate_moment_tensor(Mrr_old, Mtt_old, Mpp_old, Mtr_old, Mpr_old, Mtp_old, lat_old, lon_old, rotation_axis, rotation_angle)
    ...
    ev_momenttensor.scalar_moment=np.sqrt(Mrr**2+Mtt**2+Mpp**2+Mtr**2+Mpr**2+Mtp**2)
