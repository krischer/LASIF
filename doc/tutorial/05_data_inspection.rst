...
.. code-block:: bash
    ...
    Station and waveform information available at 3 stations:
...
on a colour scale how the stations are weighted.

.. code-block:: bash

    $ lasif plot_event GCMT_event_TURKEY_Mag_5.9_2011-5-19-20-15 --weight_set_name A

.. image:: ../images/plot_event_weighted.png
    :width: 60%
    :align: center
